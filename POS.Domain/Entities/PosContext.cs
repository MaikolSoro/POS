...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=DESKTOP-VJUI3SV\\SQLEXPRESS;Database=POS;Trusted_Connection=True; TrustServerCertificate=True;Integrated Security=true;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<BranchOffice>(entity =>
        {
            entity.HasKey(e => e.BranchOfficeId).HasName("PK__BranchOf__27247FF9B9F1E45D");
        ...
        {
            entity.HasKey(e => e.BusinessId).HasName("PK__Business__F1EAA36EFF8184F9");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__Categori__19093A0B324FFD21");
        ...
        {
            entity.HasKey(e => e.ClientId).HasName("PK__Clients__E67E1A24EE4CDD26");
        ...
        {
            entity.HasKey(e => e.DepartmentId).HasName("PK__Departme__B2079BED7BB2D5CE");
        ...
        {
            entity.HasKey(e => e.DistrictId).HasName("PK__District__85FDA4C60C69EE7F");
        ...
        {
            entity.HasKey(e => e.DocumentTypeId).HasName("PK__Document__DBA390E1DA16FA53");
        ...
        {
            entity.HasKey(e => e.MenuId).HasName("PK__Menus__C99ED230AD756022");
        ...
        {
            entity.HasKey(e => e.MenuRolId).HasName("PK__MenuRole__6640AD0CB30A61F3");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__Products__B40CC6CD305654A7");
        ...
        {
            entity.HasKey(e => e.ProviderId).HasName("PK__Provider__B54C687DE41BC63F");
        ...
        {
            entity.HasKey(e => e.ProvinceId).HasName("PK__Province__FD0A6F83DF97A0DD");
        ...
        {
            entity.HasKey(e => e.PurcharseId).HasName("PK__Purchars__A98C674B0D30CD3D");
        ...
        {
            entity.HasKey(e => e.PurcharseDetailId).HasName("PK__Purchars__7353248B831256D6");
        ...
        {
            entity.HasKey(e => e.RoleId).HasName("PK__Roles__8AFACE1A87A06F53");
        ...
        {
            entity.HasKey(e => e.SaleId).HasName("PK__Sales__1EE3C3FF24513182");
        ...
        {
            entity.HasKey(e => e.SaleDetailId).HasName("PK__SaleDeta__70DB14FE8996304F");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__Users__1788CC4C023229AE");
        ...
        {
            entity.HasKey(e => e.UserRoleId).HasName("PK__UserRole__3D978A35F8262E72");
        ...
        {
            entity.HasKey(e => e.UserBranchOfficeId).HasName("PK__UsersBra__7D1E804A3180291C");
